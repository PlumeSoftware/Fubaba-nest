...
@Entity({ database: "fmj", name: "FY_TYPE" })
...
@Entity({ database: "fmj", name: "FY_YONGTU" })
...
@Entity({ database: "fmj", name: "FY_ZHUANGXIU" })
...
@Entity({ database: "fmj", name: "FY_CHAOXIANG" })
...
//字典表 内部设施 字典类型87
@Entity({ database: "fmj", name: "SYS_PUBLIC_DETAIL" })
...
//字典表 房源特色
@Entity({ database: "fmj", name: "FENLEI_TYPE" })
